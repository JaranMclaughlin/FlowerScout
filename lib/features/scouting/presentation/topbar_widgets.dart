...
// ─────────────────────────────────────────────────────────────
//  WEATHER + NOTIFICATION TOPBAR WIDGETS
//  Drop these into your AppBar's `actions:` list
// ─────────────────────────────────────────────────────────────

// ── Color tokens (keep in sync with AppColors) ───────────────
class _C {
...
class WeatherData {
  ...
  /// Mock data — used when no API key is set or fetch fails
  ...
  factory WeatherData.fromJson(Map<String, dynamic> json) {
    ...
    return WeatherData(
      tempC: (main['temp'] as num).toDouble() - 273.15, // Kelvin → °C
...
class _WeatherChipState extends State<WeatherChip>
  ...
  // Map OWM icon codes → Flutter widget
...
class _NotificationBellState extends State<NotificationBell>
  ...
  final List<NotificationItem> _notifications = [
    NotificationItem(
      ...
      body: 'GH-12 · Kongoni: Spider mites detected on Athena',
...
class _NotificationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: AnimatedContainer(
        duration: const Duration(milliseconds: 300),
        color: item.isRead ? Colors.transparent : item.color.withOpacity(0.04),
        padding:
...
// ─────────────────────────────────────────────────────────────
//  HOW TO USE — drop into your AppBar
// ─────────────────────────────────────────────────────────────
//
//  AppBar(
//    actions: [
